      ...
      <section className="mt-[235px] flex justify-center items-center h-screen w-full px-[23px]">
        <div className="flex flex-col items-start px-[15px] py-3 gap-6 w-full bg-[#ffffff] rounded dark:bg-body-dark dark:border-btn-secondary-base border ">
          ...
          <div className="flex flex-col items-start p[5px] gap-5 w-full">
            <div className="bg-body-light-100 dark:bg-body-dark flex flex-col items-start gap-[15px] text-sm w-full rounded p-2 text-paragraph-light-200 dark:text-paragraph-light-100">
              <span>Tipo: Tranferência - Enviada</span>
              ...
              <div className="flex flex-col items-start gap-[5px] w-full">
                ...
                <div className="flex flex-col px-2.5 text-paragraph-light-100 dark:text-paragraph-light-200">
                  <span>Nome: Dhalsim Fonseca</span>
                  <span>Agência: {transaction?.receipt?.agency}</span>
                  <span>Conta: {transaction?.receipt?.account}</span>
                </div>
              </div>
            </div>
