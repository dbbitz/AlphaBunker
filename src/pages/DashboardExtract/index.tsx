  ...
  return (
    <>
      ...
      <section className="h-[405px] w-full absolute flex flex-col justify-center items-center py-3 px-4 gap-4 mt-[235px]">
        <div className="bg-[#ffffff] dark:bg-body-dark dark:border-btn-secondary-base border text-[#ffffff] flex flex-col items-center py-3 px-4 gap-6 rounded-md border-solid w-full">
          ...
          <div className="bg-body-light-100 dark:bg-body-dark flex flex-col items-start p-[5px] gap-5 rounded w-full">
